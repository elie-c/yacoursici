// Fichier de configuration pour les URLs des calendriers
// Remplacez les URLs de démonstration par les vraies URLs iCalendar (.ics) quand vous les aurez.
...
export const CALENDAR_URLS = {
  ...
  'esir41-002': 'cal-esir41-002',
  'esir41-003': 'cal-esir41-003',
  'esir41-004': 'cal-esir41-004',
  'esir41-101': 'cal-esir41-101',
  'esir41-102': 'cal-esir41-102',
  'esir41-103': 'cal-esir41-103',
  'esir41-104': 'cal-esir41-104',
};
